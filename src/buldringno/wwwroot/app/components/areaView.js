...
var AreaView = (function (_super) {
    __extends(AreaView, _super);
    function AreaView(dataService, utilityService, notificationService, routeParam) {
    ...
    AreaView.prototype.ngOnInit = function () {
    ...
    AreaView.prototype.getArea = function () {
        var _this = this;
    ...
    AreaView.prototype.getAreaBoulders = function () {
        var _this = this;
        this.dataService.get(this._page)
            .subscribe(function (res) {
            var data = res.json();
    ...
    AreaView.prototype.search = function (i) {
        _super.prototype.search.call(this, i);
        this.getAreaBoulders();
    };
    ;
    AreaView.prototype.convertDateTime = function (date) {
        return this.utilityService.convertDateTime(date);
    };
    AreaView.prototype.delete = function (boulder) {
        var _this = this;
